...
export const ALGO_VERSION = 'v63'; // v63: TICKET-031 §A 早餐蛋类 5 工作日轮换 — breakfastCombos.ts 加 EGG_PLACEHOLDER + BREAKFAST_PROTEIN_EGG_POOL (5 蛋); 13 处 side[0]='茶叶蛋' 硬编码 → placeholder; hk-tea-restaurant 港式 3 蛋后追加 placeholder; resolveSlot 加 dayIndex 参数解析 placeholder 为 dayIndex%5 轮换 → 周一-五 protein 5 蛋不重. bump 让全 v62 缓存失效。
