...
// 老板 2026-05-30 拍板权威 AppID = wx3c66070bbe747b92 (后台密钥配对的就是它)。
...
export default function Login() {
  ...
  const handleAnonymousPreview = () => {
    ...
    // 标记为 preview 模式, 给 Home 显示"升级账号"提示用 (TICKET-096 后续)
        ...
        <motion.div key="login"
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}
            ...
            <button
              ...
              className="w-full h-[44px] rounded-2xl flex items-center justify-center gap-2 font-medium transition-all active:scale-[0.98]"
              style={{
            ...
            >
              ...
              {t("Just take a look first", "先看看，不登录")}
            </button>
